...
def find_idle_instances():
    ...
    for instance in instances:
        ...
        try:
            ...
            network_in = get_metric_average(instance_id, "NetworkIn")
            network_out = get_metric_average(instance_id, "NetworkOut")

            disk_read = get_metric_average(instance_id, "DiskReadOps")
            disk_write = get_metric_average(instance_id, "DiskWriteOps")
